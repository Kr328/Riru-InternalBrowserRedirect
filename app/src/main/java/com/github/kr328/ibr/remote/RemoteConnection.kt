...
object RemoteConnection {
    val INSTANCE:IRemoteService by lazy {
        ...
        try {
            ...
            return@lazy IRemoteService.Stub.asInterface(reply.readStrongBinder()) ?: throw RemoteException("Unable to connect RemoteServer")
        }
        finally {
            data.recycle()
            reply.recycle()
